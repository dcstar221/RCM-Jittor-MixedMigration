...
class PerceptionTransformerRadar(BaseModule):
    ...
    def __init__(self,
        ...
        self.encoder = build_jittor_module(encoder)
        self.decoder = build_jittor_module(decoder)
    ...
    def init_layers(self):
        ...
        self.level_embeds = nn.Parameter(
            jt.zeros((self.num_feature_levels, self.embed_dims), dtype=jt.float32))
        self.cams_embeds = nn.Parameter(
            jt.zeros((self.num_cams, self.embed_dims), dtype=jt.float32))
    ...
    def get_bev_features(
        ...
        shift = bev_queries.clone().assign(
        ...
        # add can bus signals
        can_bus = bev_queries.clone().assign(
