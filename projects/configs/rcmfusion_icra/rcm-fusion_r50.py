...
data_root = 'data/RCM_Data/v1.0-mini/'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(type=dataset_type,
                    data_root=data_root,
                    version='v1.0-mini',
                    ann_file=data_root + 'kitti_infos_train_rcmfusion.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             version='v1.0-mini',
             ann_file=data_root + 'kitti_infos_val_rcmfusion.pkl',
